...
function popupMid(req, res, next) {
	if (/MSIE|Trident/.test(req.headers['user-agent'])) res.status(500).render(`${__dirname}/public/error.ejs`, { stacktrace: null, friendlyError: "Your browser is no longer supported by Vukkybox. Please <a href='https://browser-update.org/update-browser.html'>update your browser</a>." });
